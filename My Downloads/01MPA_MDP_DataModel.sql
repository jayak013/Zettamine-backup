...
Search functioinality for different vendor types by: 	Id / Name / City / State / Zip Code
	...
	User Roles:
	1) Super Admin
	2) User Admin   (Maintain users and their Roles)
	3) Data Entry Operator with privileges to perform CRUD-Q of different combinations of Master data
	being handled in this module  - at least 3 different type of Data Entry Operator type users
	4) Loan Origination User - Can perform search of all master data and view the data (Create or Edit feature)
...
-- Escrow agent is an licenced individual who works for an escrow company to hanlde escrow related activities.
...
/*
  As underwriting is a very important process in mortgage loan approval, the history of an underwriting company w.r.t loans approved or rejected by an underwriting company related to loans of the Mortgage company will be maintained separately for analysis purposed. 
*/
...
CREATE TABLE mpa.surveyor (
  ...
  -- fields added on 19th March
  geodetic_control BOOLEAN,  -- Does this surveyor have expertise in Geodetic Control survey
  historic_preservation BOOLEAN  -- Does this surveyor have expertise in Historic Preservation survey
);
