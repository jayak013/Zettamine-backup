...
public class AccountsController {
	 ...
	 * "REST API to create new Customer &  Account inside EazyBank" )
	 * 
	 * @ApiResponses({
	 * 
	 ...
	 * "HTTP Status Internal Server Error", content = @Content( schema
	...
	/*
	 * @Operation( summary = "Fetch Account Details REST API", description =
	 * "REST API to fetch Customer &  Account details based on a mobile number" )
	 * 
	 * @ApiResponses({
	 * 
	 ...
	 * "REST API to update Customer &  Account details based on a account number" )
	 * 
	 * @ApiResponses({
	 * 
	 * @ApiResponse( responseCode = "200", description = "HTTP Status OK" ),
	 ...
	 * description =
	 * "REST API to delete Customer &  Account details based on a mobile number" )
	 * 
	 * @ApiResponses({
	 * 
	 * @ApiResponse( responseCode = "200", description = "HTTP Status OK" ),
